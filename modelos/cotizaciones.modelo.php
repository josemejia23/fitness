...
class ModeloCotizaciones{
	...
	static public function mdlIngresarCotizacion($tabla, $datos){
		...
		$stmt = Conexion::conectar()->prepare("INSERT INTO $tabla(codigo, id_cliente, id_vendedor, productos, envio, impuesto, descuento, neto, total, metodo_pago) VALUES (:codigo, :id_cliente, :id_vendedor, :productos, :envio, :impuesto, :descuento, :neto, :total, :metodo_pago)");
