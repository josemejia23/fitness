...
class ModeloProductos{
	...
	/*=============================================
	MOSTRAR SUMA COTIZACIONES
	=============================================*/	

	static public function mdlMostrarSumaCotizaciones($tabla){

		$stmt = Conexion::conectar()->prepare("SELECT SUM(cotizacion) as total FROM $tabla");
