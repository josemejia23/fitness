              ...
              <div class="box">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control" id="nuevaCotizacion" name="nuevaCotizacion" value="10002343" readonly>
                ...
                <div class="form-group row nuevoProducto">
                  ...
                  <div class="col-xs-6" style="padding-right:0px">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control" id="agregarProducto1" name="agregarProducto1" placeholder="Descripción del producto" required>
                        ...
                        <tr>
                          ...
                          <td style="width: 50%">
                            ...
                            <div class="input-group">
                              ...
                              <input type="number" class="form-control" min="0" id="nuevoImpuestoCotizacion" name="nuevoImpuestoCotizacion" placeholder="0" required>
                           ...
                           <td style="width: 50%">
                            ...
                            <div class="input-group">
                              ...
                              <input type="number" min="1" class="form-control" id="nuevoTotalCotizacion" name="nuevoTotalCotizacion" placeholder="00000" readonly required>
