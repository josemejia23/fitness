...
$xml = ControladorCotizacion::ctrDescargarXML();

if($xml){

  rename($_GET["xml"].".xml", "xml/".$_GET["xml"].".xml");

  echo '<a class="btn btn-block btn-success abrirXML" archivo="xml/'.$_GET["xml"].'.xml" href="cotizaciones">Se ha creado correctamente el archivo XML <span class="fa fa-times pull-right"></span></a>';
      ...
      <div class="box-body">
       ...
       <table class="table table-bordered table-striped dt-responsive tablas" width="100%">
        ...
        <?php
          ...
          $respuesta = ControladorCotizacion::ctrRangoFechasCotizaciones($fechaInicial, $fechaFinal);
           ...
           echo '<tr>
                  ...
                  <td>
                    ...
                    <div class="btn-group">
                      ...
                      <a class="btn btn-success" href="index.php?ruta=cotizaciones&xml='.$value["codigo"].'">xml</a>
