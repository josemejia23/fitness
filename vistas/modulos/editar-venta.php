          ...
          <form role="form" method="post" class="formularioVenta">
            ...
            <div class="box-body">
              ...
              <div class="box">
                ...
                $porcentajeImpuesto = number_format($porcentajeImpuesto);
                $descuento = $venta["descuento"] * 100 / $venta["neto_antes_descuento"];
                $descuento = number_format($descuento);
                $envio =  $venta["envio"];
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <div class="input-group">
                              ...
                              <input type="number" step=0.01 class="form-control input-lg" min="0" id="nuevoEnvio" name="nuevoEnvio" value="<?php echo $envio; ?>" required>
                        ...
                        <tr>
                          ...
                          <td style="width: 33%">
                            ...
                            <div class="input-group">
                              ...
                              <input type="number" class="form-control input-lg" min="0" id="nuevoDescuento" name="nuevoDescuento" value="<?php echo $descuento; ?>" required>
