...
$(".tablaVentas tbody").on("click", "button.agregarProducto", function () {
	...
	$.ajax({
		...
		success: function (respuesta) {
			...
			$(".nuevoPrecioProducto").number(true, 3);
	...
	$.ajax({
		...
		success: function (respuesta) {
			...
			$(".nuevoProducto").append(
				...
				'<select class="form-control nuevoCodigoProducto" id="producto' + numProducto + '" idProducto name="nuevoCodigoProducto" required>' +
...
function agregarImpuesto() {
	...
	var envio = $("#nuevoEnvio").val();
	var NuevoEnvio = Number(envio);
	var netoDescuento = Number(precioTotal) + Number(NuevoEnvio);
	var precioDescuento = Number(netoDescuento * descuento / 100);
	precioTotal = Number(netoDescuento) - Number(precioDescuento);
	...
	$("#nuevoNetoDescuento").val(netoDescuento);
...
$("#nuevoMetodoPago").change(function () {
	...
	if (metodo == "Efectivo") {
		...
		$('#nuevoValorEfectivo').number(true, 3);
		$('#nuevoCambioEfectivo').number(true, 3);
